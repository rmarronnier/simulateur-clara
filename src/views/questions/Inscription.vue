 <template>
  <v-card class="pa-4" align="center">
          <v-card-title class="display-1 justify-center align-center">Depuis combien de temps êtes-vous inscrit•e à Pôle emploi ?</v-card-title>
    <v-form @submit.prevent="submitInscription" ref="formInscription" v-model="validity">
      <v-radio-group class="justify-center align-center" required :rules="rules" v-model="inscription">
